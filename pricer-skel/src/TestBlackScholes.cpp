...
//Option Basket
//     PnlVect* sigmaB = pnl_vect_create_from_scalar(1,0.2);
//     PnlVect* spotB = pnl_vect_create_from_scalar(1,100);
//     BlackScholesModel* BasketblackScholesModel = new BlackScholesModel(1,0.04879,0.7,sigmaB,spotB);
//     PnlVect* weightsBasket = pnl_vect_create_from_scalar(1,1);
//     BasketOption* OptionTest2 = new BasketOption(1,1,1,100,weightsBasket);
//     MonteCarlo* monteCarloBasket = new MonteCarlo(BasketblackScholesModel, OptionTest2,rng, 0.1,5000000);
//     PnlVect* delta = pnl_vect_create(1);
//     PnlVect* stdVect = pnl_vect_create(1);
//     PnlMat* past = pnl_mat_create(2,1);
//     pnl_mat_set_row(past,spotB,0);
//     PnlVect* spotB2 = pnl_vect_create_from_scalar(1,101.553051);
//     pnl_mat_set_row(past,spotB2,1);
//     double prix1 = 0.0;
//     double std1 = 0.0;
//    // pnl_mat_set_row(past,spotB,0);
// //monteCarloBasket->deltaPrice(prix1,std1,delta,stdVect);
//     monteCarloBasket->deltaPrice(past,0.0082,prix1,std1,delta,stdVect);
//     pnl_vect_print(delta);
//Option Performance  
